...
<body class="bg-gray-100">
    ...
    <br>
    <br>
    <h1 class="text-3xl justify-center text-center font-bold ">FORMATO IV</h1>
    <div class="px-4">
    ...
    <h1 class="text-[30px] justify-center text-center font-semibold">MAQUINAS Y EQUIPOS EDUCATIVOS (EQUIPOS DE COMPUTO)</h1>
