...
<body class="bg-gray-100">
    ...
    <br>
    <br>
    <h1 class="text-3xl justify-center text-center font-bold ">FORMATO II</h1>
    <div class="px-4">
    ...
    <h1 class="text-[30px] justify-center text-center font-semibold">MAQUINARIA Y EQUIPO EDUCATIVOS</h1>
    ...
    <table class="min-w-full border border-black table-fixed">
        ...
        <tbody>
            ...
            try {
                ...
                $sql = "SELECT * FROM maquinas_equipo_educativos";
