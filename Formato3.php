...
<body class="bg-gray-100">
    ...
    <br>
    <br>
    <h1 class="text-3xl justify-center text-center font-bold ">FORMATO III</h1>
    <div class="px-4">
    ...
    <h1 class="text-[30px] justify-center text-center font-semibold">MOBILIARIO EDUCATIVO</h1>
    ...
    <table class="min-w-full border border-black table-fixed">
        ...
        <tbody>
          ...
          try {
              ...
              $sql = "SELECT * FROM mobiliario_educativo";
